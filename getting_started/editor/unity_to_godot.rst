...
+-------------------+------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------+
| Standout features | * Huge community                                                                   | * Scene System                                                                                                 |
...
and no metadata. This makes Godot friendlier to VCS systems, such as Git, Subversion, or Mercurial.
...
However, we often observe a common architecture for Unity projects; one Assets folder in the root directory
